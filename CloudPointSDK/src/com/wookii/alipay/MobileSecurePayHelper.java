...
import com.wookii.alipay.FileDownloader.IDownloadProgress;
...
public class MobileSecurePayHelper {
	...
	public boolean detectMobile_sp() {
		...
		if (!isMobile_spExist) {
			...
			//
			// 捆绑安装
			boolean retrieveApkFromAssets = retrieveApkFromAssets(mContext,
					PartnerConfig.ALIPAY_PLUGIN_NAME, cachePath);
