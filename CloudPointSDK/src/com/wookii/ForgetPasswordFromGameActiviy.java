...
public class ForgetPasswordFromGameActiviy extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mSubmitButton = (Button) findViewById(ResourcesIdFactoryUtils.getId(
				getApplicationContext(), "forget_pass_button_submit"));
		mSubmitButton.setOnClickListener(mOnSubmitClickListener);
		mCloseButton = (ImageButton) findViewById(ResourcesIdFactoryUtils
				.getId(getApplicationContext(), "ib_recharge_close"));
		...
		public void onClick(View v) {
			...
			if (TextUtils.isEmpty(phoneNumber)) {
				...
				String uid = LoginMessageDataUtils
						.getUID(ForgetPasswordFromGameActiviy.this);
	...
	private void showDialog(String text) {
		if (mDialog == null) {
			mDialog = ProgressDialog.show(ForgetPasswordFromGameActiviy.this,
					"", text, true, true);
		} else {
			mDialog.show();
		}
	...
	private void showToast(String text) {
		Toast.makeText(ForgetPasswordFromGameActiviy.this, text,
