...
public class SpendMoneyProtocol extends BaseProtocol implements
		DataProtocolInterface {

	SpendMoneyProtocol spendMoneyProtocol = this;

	Handler mHandler;
	List<NameValuePair> params = new ArrayList<NameValuePair>();
	String PARAM_METHOD_NAME = "PayLogin/spendMoney/";

	public void invokeSpendMoney(String token, String uid, String gid,
			String mlmemo, int money, String password, String validation_id,
