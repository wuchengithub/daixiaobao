...
public class GetMoneyLogProtocol extends BaseProtocol implements
		DataProtocolInterface {

	GetMoneyLogProtocol getMoneyLogProtocol = this;
	Handler mHandler;
	List<NameValuePair> params = new ArrayList<NameValuePair>();
	String PARAM_METHOD_NAME = "PayLogin/getMoneyLog/";

	public void invokeGetMoneyLog(String token, String uid, String mtype,
			Handler handler) {
		...
		RequestProtocolTask httpRequestTask = new RequestProtocolTask(
				PARAM_METHOD_NAME, params, getMoneyLogProtocol);
