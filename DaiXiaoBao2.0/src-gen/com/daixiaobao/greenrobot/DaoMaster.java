...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        AttrbDao.createTable(db, ifNotExists);
        FeatureDao.createTable(db, ifNotExists);
        AfterSalesDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        AttrbDao.dropTable(db, ifExists);
        FeatureDao.dropTable(db, ifExists);
        AfterSalesDao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(AttrbDao.class);
        registerDaoClass(FeatureDao.class);
        registerDaoClass(AfterSalesDao.class);
